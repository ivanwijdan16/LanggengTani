          ...
          @if(count($users) > 0)
            @foreach ($users as $user)
              <tr>
                ...
                <td>{{ $user->email }}</td>
                <td>
                  <span class="role-badge {{ $user->role === 'owner' ? 'role-owner' : 'role-employee' }}">
                ...
                <td>
                  <div class="action-buttons">
                    @if ($user->role !== 'owner')
                      <a href="{{ route('user.edit', $user->id) }}" class="btn btn-warning btn-sm d-flex align-items-center">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Apakah Anda yakin ingin menghapus pegawai <span class="modal-username" id="deleteUserName"></span>?</p>
...
<script>
  ...
  function openDeleteModal(userId, userName) {
    ...
    currentDeleteForm = document.querySelector(`.delete-form button[onclick="openDeleteModal('${userId}', '${userName}')"]`)
      .closest('form');
