              ...
              <tbody>
                ...
                @foreach ($penjualans as $penjualan)
                  <tr class="table-row" data-penjualan-id="{{ $penjualan->id }}">
                    <td><span class="badge bg-light text-dark">{{ $penjualan->id_penjualan }}</span></td>
                    <td>
                      {{ \Carbon\Carbon::parse($penjualan->created_at)->format('d-m-Y') }}
                      <small class="text-muted d-block">{{ \Carbon\Carbon::parse($penjualan->created_at)->format('H:i') }}</small>
                    </td>
                    <td class="currency text-start">
                      {{ number_format($penjualan->total_price, 0, ',', '.') }}</td>
                    <td>
                      <button type="button" class="btn btn-sm p-0 toggle-details" data-penjualan-id="{{ $penjualan->id }}">
                          ...
                          <div class="details-content">
                            <div class="detail-row">
                              <div class="detail-item">
                                ...
                                @if ($item->product)
                                  <span class="stock-id">{{ $item->product->stock_id }}</span>
                                @endif
                              </div>
                              ...
                              <div class="detail-item">
                                ...
                                <span class="detail-value">Rp {{ number_format($item->price, 0, ',', '.') }}</span>
                              </div>
                              ...
                              <div class="detail-item">
                                ...
                                <span class="detail-value fw-bold">Rp {{ number_format($item->subtotal, 0, ',', '.') }}</span>
                              </div>
                            </div>
                          </div>
                        @endforeach
