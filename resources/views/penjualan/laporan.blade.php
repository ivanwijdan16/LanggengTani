...
<body>
  <div class="container">
    <div class="header">
      ...
      <p class="report-subtitle">Bulan {{ Carbon\Carbon::createFromDate($tahun, $bulan, 1)->locale('id')->translatedFormat('F Y')}}</p>
    </div>
    ...
    <div class="summary-box">
      ...
      <div class="summary-value">{{ $data['jumlah'] }} pcs (Rp {{ number_format($data['total'], 0, ',', '.') }})</div>
    </div>
    @endforeach
